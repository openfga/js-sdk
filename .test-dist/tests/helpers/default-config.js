...
exports.defaultConfiguration = exports.baseConfig = exports.OPENFGA_CLIENT_ASSERTION_SIGNING_KEY = exports.OPENFGA_API_TOKEN = exports.OPENFGA_CLIENT_SECRET = exports.OPENFGA_CLIENT_ID = exports.OPENFGA_API_AUDIENCE = exports.OPENFGA_API_TOKEN_ISSUER = exports.OPENFGA_API_URL = exports.OPENFGA_MODEL_ID = exports.OPENFGA_STORE_ID = void 0;
const client_1 = require("../../client");
const credentials_1 = require("../../credentials");
exports.OPENFGA_STORE_ID = "01H0H015178Y2V4CX10C2KGHF4";
exports.OPENFGA_MODEL_ID = "01HWBBMZTT7F1M97DVXQK4Z7J3";
exports.OPENFGA_API_URL = "https://api.fga.example";
exports.OPENFGA_API_TOKEN_ISSUER = "tokenissuer.fga.example";
exports.OPENFGA_API_AUDIENCE = "https://api.fga.example/";
exports.OPENFGA_CLIENT_ID = "01H0H3D8TD07EWAQHXY9BWJG3V";
exports.OPENFGA_CLIENT_SECRET = "this-is-very-secret";
exports.OPENFGA_API_TOKEN = "fga_abcdef";
exports.OPENFGA_CLIENT_ASSERTION_SIGNING_KEY = `-----BEGIN PRIVATE KEY-----
...
-----END PRIVATE KEY-----`;
exports.baseConfig = {
    storeId: exports.OPENFGA_STORE_ID,
    authorizationModelId: exports.OPENFGA_MODEL_ID,
    apiUrl: exports.OPENFGA_API_URL,
    credentials: {
        method: credentials_1.CredentialsMethod.ClientCredentials,
        config: {
            apiTokenIssuer: exports.OPENFGA_API_TOKEN_ISSUER,
            apiAudience: exports.OPENFGA_API_AUDIENCE,
            clientId: exports.OPENFGA_CLIENT_ID,
            clientSecret: exports.OPENFGA_CLIENT_SECRET,
        }
    }
};
exports.defaultConfiguration = new client_1.ClientConfiguration(exports.baseConfig);
